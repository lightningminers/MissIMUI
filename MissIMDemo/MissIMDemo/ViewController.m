...
- (IBAction)gotoMissIMController:(UIButton *)sender {
    ...
    [im addInfoDataSource:@{@"nickname":@"wen",@"userId":@"icepygodman",@"iconUrl":@"http://www.battlenet.com.cn/static-render/cn/hearthglen/173/58685869-avatar.jpg?alt=wow/static/images/2d/avatar/7-0.jpg"}];
